function [fixedPoint, fixedPointFval,iteratePoint] = fixedPt(fun, maxIter, x0, option,area)
    % FIXEDPT 用不动点迭代法求解非线性方程
    %   FIXEDPT(fun, maxIter, x0, option,area)
    %   Inputs
    %       fun - 输入的函数
    %       maxIter - 最大迭代次数
    %       x0 - 初始点
    ...
    %       option = 1
    %       area = [-1, 1]
    %       [fixedPoint, fixedPointFval, iteratePoint] = fixedPt(fun, maxIter, x0, option,area)
    %
