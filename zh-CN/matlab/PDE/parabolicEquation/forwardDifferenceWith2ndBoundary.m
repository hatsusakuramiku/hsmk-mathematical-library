function [fval, fvalMatrix] = forwardDifferenceWith2ndBoundary(xRange, initial, coefficient, fun, conditions, xNum, tNum, tStep)
    ...
    for i = 2:1:tNum + 1
        funVector_ = [funVector(1) + gridRadio * boundaryMatrix(i, 1),funVector(2:end-1),...
         funVector(1) + gridRadio * boundaryMatrix(i, 2)];
        fvalMatrix(i, 2:end - 1) = (aMatrix * fvalMatrix(i - 1, 2:end - 1)')' + funVector_;
    end
